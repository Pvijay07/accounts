...
<?= $this->section('title') ?>TDS Management<?= $this->endSection() ?>
...
<div class="card shadow-sm mb-4 border-0" style="border-radius: 20px; background: rgba(255,255,255,0.7); backdrop-filter: blur(12px);">
    <div class="card-body p-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
        ...
        <div class="nav-pills-premium d-flex gap-2 bg-light p-1 rounded-pill border shadow-sm">
            <a class="nav-link-premium active shadow-sm" href="<?= base_url('manager/tds') ?>">TDS on Income (Inward)</a>
            <a class="nav-link-premium" href="<?= base_url('manager/tds/expense') ?>">TDS on Expenses (Outward)</a>
        </div>
    </div>
</div>
...
<div class="row g-4 mb-4">
        ...
        <div class="card h-100 border-0 shadow-sm premium-card overflow-hidden">
            <div class="card-body p-4 position-relative">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <div class="icon-shape bg-soft-info text-info rounded-4 shadow-sm"><i class="fas fa-calendar-day"></i></div>
                </div>
    ...
    <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm premium-card overflow-hidden" style="border-left: 5px solid #8b5cf6 !important;">
            <div class="card-body p-4 position-relative">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        <div class="text-muted text-uppercase fw-bold small mb-1" style="letter-spacing:1px;">TDS Collected on Income</div>
                        <h3 class="fw-extrabold mb-0" style="color: #8b5cf6;">₹<?= number_format($totalOutputTDS??0, 2) ?></h3>
                    </div>
                    <div class="icon-shape text-white rounded-4 shadow-sm" style="background: linear-gradient(135deg, #8b5cf6, #7c3aed);"><i class="fas fa-file-invoice-dollar"></i></div>
                </div>
                <div class="text-muted x-small fw-medium">Total TDS deducted by clients.</div>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm premium-card overflow-hidden">
            <div class="card-body p-4 position-relative d-flex align-items-center justify-content-center text-center">
                <div class="w-100">
                    <button class="btn btn-outline-primary rounded-pill px-4 fw-bold shadow-none w-100 py-3 d-flex align-items-center justify-content-center">
...
<div class="card shadow-sm border-0 mb-5" style="border-radius: 20px;">
    <div class="card-header bg-white border-0 p-4">
        <h6 class="mb-0 fw-bold text-dark">Income TDS Records</h6>
    </div>
    <div class="card-body p-0">
        <!-- Structural Placeholder for Live Data -->
        <div class="text-center py-5">
            <div class="registry-empty-state opacity-50 mb-3">
                <div class="icon-circle bg-light mx-auto mb-3" style="width:80px; height:80px;"><i class="fas fa-file-contract fa-2x text-muted"></i></div>
            </div>
            <h6 class="fw-bold text-dark mb-1">TDS Records Automatically Synced</h6>
            <p class="text-muted small mb-4 mx-auto" style="max-width:400px;">TDS values are shown directly in the Income / Expense ledgers and aggregated here.</p>
        </div>
    </div>
    <div class="card-footer bg-soft-light border-0 py-3 px-4 rounded-bottom-4">
        <p class="x-small text-muted fw-bold mb-0">
            <i class="fas fa-info-circle text-info me-1"></i> NOTE: Ensure Form 16/26AS matches these values.
        </p>
    </div>
</div>
